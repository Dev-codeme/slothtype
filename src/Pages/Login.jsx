            ...
            <div className="flex flex-col justify-center items-center shadow-normal shadow-primary rounded-lg py-7 px-10">
                ...
                <form onSubmit={login} className="flex flex-col justify-around items-center gap-3 p-10 text-secondary">
                    <div className="border-2 border-secondary rounded-lg px-2 py-2 w-72">
                        <input className="outline-none bg-transparent w-full" autoFocus type="text" autoComplete="email" placeholder="email" spellCheck="false" />
                    </div>
                    ...
                    <button disabled={loginDisabled} className="w-fit h-fit border-2 text-lg border-secondary rounded-lg mt-3 px-5 py-2 hover:bg-secondary hover:text-black duration-150 disabled:border-gray-400 disabled:text-gray-400 disabled:bg-transparent">{loginDisabled ? 'Loading...' : 'Login'}</button>
                </form>
